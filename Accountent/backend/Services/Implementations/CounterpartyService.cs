...
namespace backend.Services.Implementations
{
    public class CounterpartyService : ServiceBase<CounterpartyService>, ICounterpartyService
    {
        ...
        public async Task<(CounterpartyResponse? counterparty, string? error)> CreateAsync(
            CreateCounterpartyRequest request)
        {
            ...
            return (_mapper.MapCounterpartyResponse(entity), null);
        }

        public async Task<(CounterpartyResponse? counterparty, string? error)> UpdateAsync(
            int id, UpdateCounterpartyRequest request)
        {
            ...
            if (entity is null)
                return (null, "Контрагент не найден.");
        ...
        public async Task<(bool success, string? error)> DeleteAsync(int id)
        {
            ...
            if (usedInTransactions || usedInLines)
                return (false, "Нельзя удалить контрагента, используемого в проводках.");
